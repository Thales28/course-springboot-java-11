...
import com.estudos.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User(null, "Maria Brown", "maria@gmail.com", "9997799", "23452" );
		User u2 = new User(null, "Alex Green", "alex@gmail.com", "9997889", "54321" );
		...
		OrderItem oi5 = new OrderItem(o1, p2, 1, p2.getPrice());
